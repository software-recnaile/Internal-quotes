...
const Hero = () => {
  ...
  return (
    ...
    <main className="bg-gray-900 w-screen h-screen overflow-x-hidden">
  ...
  <div className="viewer-container flex flex-col lg:flex-row gap-4 w-full h-full p-4 pt-2">
    ...
    {/* {loading && (
      <div className="flex items-center justify-center text-2xl font-bold text-white w-screen">
        Loading STL file...
      </div>
    )} */}

    <div className="model border-2 rounded-2xl w-full lg:w-4/5 h-[60vh] lg:h-[80vh] bg-[#FFFEFE] m-2 p-2">
      <Canvas
